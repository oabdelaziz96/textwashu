...
//Helper Resources:
  app.get('/highcharts.js', function(req, res){ //Highcharts data
...
app.post('/', function(req, res){ //Process Twilio Request --SHOULD CHANGE TO PATH
  
  var toPhoneNumber = req.body.twilioNumber;
  io.sockets.in(toPhoneNumber).emit('message_to_client', {message:req.body.body});
